...
import { ChevronLeft, ChevronRight, Smartphone, Star, Heart } from "lucide-react"
...
export default function AppPreviewSection() {
  ...
  const screenshots = [
    ...
    {
      title: "Dashboard",
      description: "Personalized recommendations and daily beauty insights",
      image: "/placeholder.svg?height=600&width=300",
      alt: "BeautiCare AI Dashboard",
    },
    {
      title: "Style Analysis",
      description: "AI-powered facial analysis and feature detection",
      image: "/placeholder.svg?height=600&width=300",
      alt: "BeautiCare AI Style Analysis",
    },
    {
      title: "Recommendations",
      description: "Customized styling suggestions for hair, makeup, and clothing",
      image: "/placeholder.svg?height=600&width=300",
      alt: "BeautiCare AI Recommendations",
    },
  ]
  ...
  return (
    <section id="app-preview" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white to-[#FAE7FB]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="md:hidden">
          <div className="relative max-w-sm mx-auto">
            ...
            <div className="mt-8 text-center">
              <h3 className="text-xl font-bold text-gray-800 mb-2">{screenshots[currentSlide].title}</h3>
          ...
          {screenshots.map((screenshot, index) => (
            <div key={index} className="group">
              ...
              <div className="mt-6 text-center">
                <h3 className="text-lg font-bold text-gray-800 mb-2">{screenshot.title}</h3>
                <p className="text-gray-600 text-sm leading-relaxed">{screenshot.description}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">AI-driven recommendations tailored to your unique features and preferences</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Clean, modern design that makes beauty discovery effortless and enjoyable</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Instant facial feature detection and styling suggestions using advanced AI</p>
          </div>
        </div>
      </div>
    </section>
